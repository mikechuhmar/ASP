...
namespace PC
{
    class GV
    {
        ...
        public static int MJU = 20, MEU = 20, MJI = 20, MEI = 20, MTRI = 20, MOUI = 20, MTB = 20, MTU = 20, MOU = 20;
        public static int nv, n, nr, nl, nc, nju, neu, nji, nei, nf, lp, lm, kp, km, k;
        ...
        public static float[] z_ju = new float[MJU + 1];
        public static float[] z_eu = new float[MEU + 1];
