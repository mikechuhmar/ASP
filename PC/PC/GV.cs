...
namespace PC
{
    class GV
    {
        ...
        public static int MJU = 20, MEU = 20, MJI = 20, MEI = 20, MTRI = 20, MOU = 20;
        public static int nv, n, nr, nl, nc, neu, nei, ntri, nou, nf, lp, lm, kp, km, k;
        ...
        //4 lab 
        public static int[,] in_ou = new int[MR + 1, 5];
        ...
        //4 lab
        public static float[,] z_ou = new float[MR + 1, 4];
        //...
